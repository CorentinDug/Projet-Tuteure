...
class platController implements ControllerProviderInterface{
    ...
    public function addPlat(Application $app) {
        ...
        return $app["twig"]->render('plats/v_form_create_plats.html.twig',['typePlat'=>$typePlat]);
    }
    ...
    public function deletePlat(Application $app, $id) {
        ...
        return $app["twig"]->render('plats/v_form_delete_plats.html.twig',['donnees'=>$platModel]);
    }
    ...
    public function editPlat(Application $app,$id) {
        ...
        return $app["twig"]->render('plats/v_form_update_plats.html.twig',['donnees'=>$donnees, 'typePlat'=>$typePlat]);
    }
    ...
    public function validFormAddPlat(Application $app ) {
        ...
        if (1==1){
            ...
            if(! empty($erreurs))
            {
                $this->typePlatModel = new TypePlatModel($app);
                $typePlat = $this->typePlatModel->getAllTypePlat();
                return $app["twig"]->render('plats/v_form_create_plats.html.twig',['donnees'=>$donnees,'erreurs'=>$erreurs,'typePlat'=>$typePlat]);
            }
            else
            {
                $this->platModel = new PlatModel($app);
    ...
    public function validFormEditPlat(Application $app,Request $req){
        ...
        if(! empty($erreurs))
        {
            $this->typePlatModel = new TypePlatModel($app);
            $typePlat = $this->typePlatModel->getAllTypePlat();
            return $app["twig"]->render('plats/v_form_update_plats.html.twig',['donnees'=>$donnees,'erreurs'=>$erreurs,'typePlat'=>$typePlat]);
        }
        else
        {
            $this->platModel = new PlatModel($app);
